...
int main()
{
    ...
    Shader shader("1_9.8_1_shader.vs", "1_9.8_1_shader.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::rotate(model, (float)glfwGetTime(), glm::vec3(0.5f, 1.0f, 0.0f)); //matrice model, rappresenta l'oggetto 
        //ruotato nel tempo attorno all'asse x e y
        ...
        //proiezione projection che simula la visione di una scena 3D, FOV angolo di campo visivo (angolo di visualizzazione della
        ...
        glBindVertexArray(VAO); //attiva il VAO, contiene tutte le informazioni su come i dati dei vertici sono organizzati
        glDrawArrays(GL_TRIANGLES, 0, 36); //36 vertici con il tipo GL_TRIANGLES, cubo composto da triangoli
