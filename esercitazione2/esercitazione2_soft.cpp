...
int main()
{
    ...
    //Gestiscono il rendering della scena finale con illuminazione, texture e calcolo delle ombre morbide
    Shader shader("point_shadow.vs", "point_shadow_soft.fs");
    //Gestiscono il primo passaggio del rendering delle ombre(depth cube map)
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindFramebuffer(GL_FRAMEBUFFER, 0);
        // render normale della scena, rendering finale
