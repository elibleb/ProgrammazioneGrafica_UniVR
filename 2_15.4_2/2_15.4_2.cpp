...
int main()
{
    ...
    //cubo principale
    Shader lightingS("2_15.4_2_lighting_maps.vs", "2_15.4_2_lighting_maps.fs");
    //cubo sorgente luminosa
    Shader lightCubeS("2_15.4_2_light_cube.vs", "2_15.4_2_light_cube.fs");
    ...
    unsigned int specularMap = loadTexture("textures/lighting_maps_specular_color.jpg");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        glClearColor(0.1f, 0.2f, 0.7f, 1.0f); //imposta colore dello sfondo
        ...
        lightingS.setFloat("material.shininess", 64.0f);
        ...
        // esegue il bind della specular map
