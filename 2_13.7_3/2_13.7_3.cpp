...
int main()
{
    ...
    //cubo principale
    Shader lightingS("2_13.7_3_basic_lighting.vs", "2_13.7_3_basic_lighting.fs");
    //cubo piccolo sorgente di luce
    Shader lightCubeS("2_13.7_3_light_cube.vs", "2_13.7_3_light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        glClearColor(0.2f, 0.0f, 0.0f, 1.0f); //imposta colore sfondo
        ...
        lightPos.x = 1.0f + sin(glfwGetTime()) * 2.0f; //coordinata x della luce oscillerà tra -1.0 e 3.0
        lightPos.y = sin(glfwGetTime() / 2.0f) * 1.0f; //coordinata y della luce oscillerà tra -1.0 e 1.0
