...
int main()
{
    ...
    Shader lightingS("2_16.6_lighting_casters.vs", "2_16.6_lighting_casters.fs");
    Shader lightCubeS("2_16.6_light_cube.vs", "2_16.6_light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingS.use();
        lightingS.setVec3("light.position", camera.Position); //posizione della luce, qui è la posizione della camera
        lightingS.setVec3("light.direction", camera.Front); //direzione della luce, qui è la direzione in cui la camera sta guardando
        //cono illuminato e definisconola luce al suo interno
        lightingS.setFloat("light.cutOff", glm::cos(glm::radians(12.5f))); 
        lightingS.setFloat("light.outerCutOff", glm::cos(glm::radians(17.5f)));
        lightingS.setVec3("viewPos", camera.Position);


        // proprietà della luce
        lightingS.setVec3("light.ambient", 0.1f, 0.1f, 0.1f);
        lightingS.setVec3("light.diffuse", 0.8f, 0.8f, 0.8f);
        lightingS.setVec3("light.specular", 1.0f, 1.0f, 1.0f);
        lightingS.setFloat("light.constant", 1.0f); //valore alto, la luce non si attenua in modo costante
        lightingS.setFloat("light.linear", 0.09f); //più alto è,più veloce la luce si attenua
        lightingS.setFloat("light.quadratic", 0.032f); //attenuazione quadratica: più alto è,più veloce la luce si attenua con la distanza
