...
int main()
{
    ...
    Shader lightingS("2_17.3_multiple_lights.vs", "2_17.3_multiple_lights.fs");
    Shader lightCubeS("2_17.3_light_cube.vs", "2_17.3_light_cube.fs");
    ...
    // setta le posizioni di tutte le luci
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        glClearColor(0.8f, 0.35f, 0.4f, 1.0f); //imposta colore dello sfondo
        ...
        lightingS.use();
        lightingS.use();
        lightingS.setVec3("viewPos", camera.Position); //posizione della camera
        lightingS.setFloat("material.shininess", 32.0f); //lucentezza del materiale
        
       

        // setta le proprietà delle luci
       // luce direzionale, da una direzione specifica, stesso effetto su tutti gli oggetti della scena
        lightingS.setVec3("dirLight.direction", -0.2f, -1.0f, -0.3f);
        lightingS.setVec3("dirLight.ambient", 0.05f, 0.05f, 0.05f);
        lightingS.setVec3("dirLight.diffuse", 0.4f, 0.4f, 0.4f);
        lightingS.setVec3("dirLight.specular", 0.5f, 0.5f, 0.5f);
        // point light 1 : emettono luce in tutte le direzioni da una posizione specifica
        lightingS.setVec3("pointLights[0].position", pointLightPositions[0]);
        lightingS.setVec3("pointLights[0].ambient", 0.05f, 0.05f, 0.05f);
        lightingS.setVec3("pointLights[0].diffuse", 0.8f, 0.8f, 0.8f);
        lightingS.setVec3("pointLights[0].specular", 1.0f, 1.0f, 1.0f);
        lightingS.setFloat("pointLights[0].constant", 1.0f); // attenuazioni: valore alto, la luce non si attenua in modo costante
        lightingS.setFloat("pointLights[0].linear", 0.09f); //più alto è,più veloce la luce si attenua
        lightingS.setFloat("pointLights[0].quadratic", 0.032f); //attenuazione quadratica: più alto è,più veloce la luce si attenua con la distanza
        // point light 2
        lightingS.setVec3("pointLights[1].position", pointLightPositions[1]);
        lightingS.setVec3("pointLights[1].ambient", 0.05f, 0.05f, 0.05f);
        lightingS.setVec3("pointLights[1].diffuse", 0.8f, 0.8f, 0.8f);
        lightingS.setVec3("pointLights[1].specular", 1.0f, 1.0f, 1.0f);
        lightingS.setFloat("pointLights[1].constant", 1.0f);
        lightingS.setFloat("pointLights[1].linear", 0.09f);
        lightingS.setFloat("pointLights[1].quadratic", 0.032f);
        // point light 3
        lightingS.setVec3("pointLights[2].position", pointLightPositions[2]);
        lightingS.setVec3("pointLights[2].ambient", 0.05f, 0.05f, 0.05f);
        lightingS.setVec3("pointLights[2].diffuse", 0.8f, 0.8f, 0.8f);
        lightingS.setVec3("pointLights[2].specular", 1.0f, 1.0f, 1.0f);
        lightingS.setFloat("pointLights[2].constant", 1.0f);
        lightingS.setFloat("pointLights[2].linear", 0.09f);
        lightingS.setFloat("pointLights[2].quadratic", 0.032f);
        // point light 4
        lightingS.setVec3("pointLights[3].position", pointLightPositions[3]);
        lightingS.setVec3("pointLights[3].ambient", 0.05f, 0.05f, 0.05f);
        lightingS.setVec3("pointLights[3].diffuse", 0.8f, 0.8f, 0.8f);
        lightingS.setVec3("pointLights[3].specular", 1.0f, 1.0f, 1.0f);
        lightingS.setFloat("pointLights[3].constant", 1.0f);
        lightingS.setFloat("pointLights[3].linear", 0.09f);
        lightingS.setFloat("pointLights[3].quadratic", 0.032f);
        // spotLight: emette un fascio di luce concentrato da una posizione specifica e si propaga in una specifica direzione
        lightingS.setVec3("spotLight.position", camera.Position); //posizione uguale a quella della camera, la luce seguirà la 
                                                                  //posizione della vista dell'utente
        lightingS.setVec3("spotLight.direction", camera.Front); //direzione in cui la luce spotlight è proiettata,è la direzione in cui la
                                                                //camera è orientata 
        lightingS.setVec3("spotLight.ambient", 0.0f, 0.0f, 0.0f);
        lightingS.setVec3("spotLight.diffuse", 1.0f, 1.0f, 1.0f);
        lightingS.setVec3("spotLight.specular", 1.0f, 1.0f, 1.0f);
        lightingS.setFloat("spotLight.constant", 1.0f);
        lightingS.setFloat("spotLight.linear", 0.09f);
        lightingS.setFloat("spotLight.quadratic", 0.032f);
        lightingS.setFloat("spotLight.cutOff", glm::cos(glm::radians(12.5f)));
        lightingS.setFloat("spotLight.outerCutOff", glm::cos(glm::radians(15.0f)));
        ...
        for (unsigned int i = 0; i < 4; i++)
        {
            ...
            model = glm::scale(model, glm::vec3(0.2f)); // scala, cubo più piccolo
