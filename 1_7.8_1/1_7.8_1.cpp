...
int main()
{
    ...
    Shader shader("1_7.8_1_shader.vs", "1_7.8_1_shader.fs");
    ...
    glGenTextures(1, &texture1); // Crea una texture vuota e la memorizza nell'array texture. Il primo parametro è 1
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        glClearColor(0.7f, 0.9f, 0.9f, 1.0f); //definisce il colore
