...
void main()
{
	...
	//Campionamento colore texture2: la componente x delle coordinate di texture viene invertita (1 - TexCoord.x)
	//Questo cambia l'orientamento orizzontale della texture2, effetto di riflessione orizzontale della texture
