...
int main()
{
    ...
    Shader shader("1_8.17_2_shader.vs", "1_8.17_2_shader.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        trans = glm::translate(trans, glm::vec3(0.5f, -0.5f, 0.0f)); //applicata una traslazione alla matrice trans, trasformazione
