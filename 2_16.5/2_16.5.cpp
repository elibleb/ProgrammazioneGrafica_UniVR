...
int main()
{
    ...
    Shader lightingS("2_16.5_lighting_casters.vs", "2_16.5_lighting_casters.fs");
    Shader lightCubeS("2_16.5_light_cube.vs", "2_16.5_light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingS.use();
        lightingS.setVec3("light.position", camera.Position);
        lightingS.setVec3("light.direction", camera.Front);
