...
int main()
{
    ...
    Shader shader("1_7.7_shader.vs", "1_7.7_shader.fs");
    ...
    glGenTextures(1, &texture1); // Crea una texture vuota e la memorizza nell'array texture. Qui stiamo creando una sola texture
    ...
    stbi_set_flip_vertically_on_load(true); //inverte verticalmente l'immagine durante il caricamento
    ...
    //stesso comportamento della prima
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        glClearColor(0.7f, 0.9f, 0.9f, 1.0f); //funzione che setta lo stato
