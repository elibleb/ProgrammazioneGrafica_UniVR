...
int main()
{
    ...
    Shader shader("1_8.19_1_shader.vs", "1_8.19_1_shader.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        glClearColor(1.0f, 0.8f, 0.6f, 1.0f); //imposto colore sfondo
        glClear(GL_COLOR_BUFFER_BIT); //cancella il buffer del colore impostando quello appena definito
        ...
        trans = glm::rotate(trans, (float)glfwGetTime(), glm::vec3(0.0, 0.0, 1.0)); //rotazione della matrice trans attorno asse Z
        ...
        trans = glm::translate(trans, glm::vec3(0.5f, -0.5f, 0.0f)); // applicata una traslazione alla matrice trans
        ...
        glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm::value_ptr(trans)); //la matrice trans 
