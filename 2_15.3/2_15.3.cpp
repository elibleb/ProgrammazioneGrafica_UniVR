...
int main()
{
    ...
    //cubo principale
    Shader lightingS("2_15.3_lighting_maps.vs", "2_15.3_lighting_maps.fs");
    //cubo sorgente luminosa
    Shader lightCubeS("2_15.3_light_cube.vs", "2_15.3_light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingS.setFloat("material.shininess", 64.0f); //imposta la lucentezza del materiale
