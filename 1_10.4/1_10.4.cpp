...
int main()
{
    ...
    Shader shader("1_10.4_camera.vs", "1_10.4_camera.fs");
    ...
    // posizioni dei cubi nello spazio
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render
        glClearColor(0.2f, 0.4f, 0.6f, 1.0f); //imposta il colore dello sfondo
        ...
        // camera transform
        //creazione matrice view matrix, definisce la posizione e l'orientamento della camera nella scena
...
void processInput(GLFWwindow* window)
{
    ...
    float cameraSpeed = static_cast<float>(2.5 * deltaTime); //velocità di movimento della camera
